  ...
  function ImageRing() {
    ...
    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "getImages", function () {
      ...
      return images.map(function (image, i) {
        ...
        var style = {
          width: "".concat(100 / 3.5, "%"),
          paddingTop: "".concat(100 / 3.5, "%"),
          // height: imageSize,
          // margin: -imageSize / 2,
          // transform: `rotate(${rotation}deg) translate(${radius}px) rotate(-${rotation}deg)`,
          zIndex: i % 2 + 1,
          backgroundImage: "url(".concat(image, ") no-repeat center")
        };
        return __jsx("span", {
...
//# sourceMappingURL=index.js.cd2fdf1ea5f212f15c8e.hot-update.js.map